                ...
                <section className="space-y-12 bg-white/60 glass-morphism p-12 rounded-[3.5rem] border-white">
                    ...
                    <div className="space-y-10 text-slate-600 font-light leading-relaxed">
                        <div className="space-y-4">
                            <h3 className="text-xl font-bold text-slate-900">Clinical Data Integrity</h3>
                            <p>
                                AlzDetect is an enterprise-grade diagnostic prototype. We prioritize the security and privacy of uploaded medical imaging data. Any MRI images uploaded for analysis are processed exclusively for classification purposes and are not stored in any permanent medical records through this platform.
                            </p>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <p>
                                We collect basic usage metrics and anonymized classification results to improve the underlying Vision Transformer model. This information is used strictly for clinical systems tracking and model refinement.
                            </p>
                        </div>
                        ...
                        <div className="p-8 bg-indigo-50/50 rounded-3xl border border-indigo-100/50 space-y-4">
                            ...
                            <p className="text-indigo-800 text-xs italic">
                                While AlzDetect follows best practices for medical data security, this instance is a technical demonstration and should not be used for HIPAA-regulated patient workflows without enterprise-grade deployment.
                            </p>
                        </div>
                    </div>
                </section>
