                ...
                <section className="space-y-12 bg-white/60 glass-morphism p-12 rounded-[3.5rem] border-white">
                    ...
                    <div className="space-y-10 text-slate-600 font-light leading-relaxed">
                        <div className="space-y-4">
                            ...
                            <p>
                                By utilizing the AlzDetect platform, you agree to these Terms of Service. This platform is provided strictly for clinical demonstration purposes. Any diagnostic outputs generated are support signals and not definitive clinical diagnoses.
                            </p>
                        </div>
