            ...
            <main className="max-w-7xl mx-auto px-4 py-20">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative glass-card rounded-[3rem] p-12 text-center space-y-8 border-white/40">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900">Current Technical Focus</h2>
                ...
                <section className="grid md:grid-cols-3 gap-8 mb-24">
                    {[
                        ...
                        { title: "AI Ethics", path: "/ethics", icon: <Shield className="w-6 h-6" />, desc: "Clinical ethics, data privacy, and diagnostic integrity." }
                    ].map((item, i) => (
