            ...
            <main className="max-w-4xl mx-auto px-4 py-20">
                ...
                <div className="space-y-16">
                    <div className="space-y-4">
                        ...
                        <p className="text-slate-500 font-light text-lg">Detailed guide for researchers and developers on how to interact with the AlzDetect system.</p>
                    </div>
                    ...
                    <section className="space-y-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="p-8 bg-white rounded-3xl border border-slate-100 shadow-sm space-y-4">
                                ...
                                <h3 className="font-bold text-slate-900">Research API</h3>
                    ...
                    <section className="p-8 bg-amber-50 rounded-[2rem] border border-amber-100 flex gap-6">
                        ...
                        <div className="space-y-2">
                            <h4 className="font-black text-amber-900 uppercase tracking-widest text-[10px]">Research Prototype Warning</h4>
                            <p className="text-amber-800 text-sm font-light leading-relaxed italic">
                                AlzDetect is a research prototype designed for demonstration purposes. It is not intended for clinical use or primary diagnosis without verification by a certified medical professional.
                            </p>
                        </div>
                    </section>
                </div>
