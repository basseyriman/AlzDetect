...
import { ArrowLeft, Play, Activity, Cpu, Sparkles, Brain } from "lucide-react";
                        ...
                        <div className="flex flex-col lg:flex-row gap-12 items-center">
                            ...
                            <div className="lg:w-1/2 relative">
                                <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl animate-float">
                                    <Image src="/ai_brain.png" alt="Demo Brain" width={600} height={600} className="w-full h-auto grayscale hover:grayscale-0 transition-all duration-1000" />
                ...
                <section className="grid md:grid-cols-4 gap-12 mb-20 text-left">
                    {[
                        ...
                        <div key={i} className="space-y-4">
                            <div className="text-4xl font-black text-indigo-400 italic">{(i + 1).toString().padStart(2, '0')}</div>
